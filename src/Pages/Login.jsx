      ...
      >
        ...
        >
          <img
            src={person}
            className="mt-4 mb-5"
            style={{ borderRadius: "50%", background: "transparant" }}
            alt="icon"
            height="100px"
          ></img>
          ...
          <div className="form-floating">
            <input
              ...
              style={{ fontSize: 16, width: "90%", borderRadius: 20 }}
            ></input>
            <label htmlFor="title" className="text-center loginlabel">
              Register Email{" "}
            </label>
          </div>
          <div className="mb-3 ">
          ...
          <div
            className="dark text-center mt-2 mb-4"
            style={{
              fontSize: 16,
              height: "fit-content",
              width: "100%",
